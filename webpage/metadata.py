...
PROJECT_METADATA = {
    ...
    'subtitle_en': 'Online database for research on the development of vessel shapes and dimensions',
    'subtitle_de': 'Online-Datenbank zur Erforschung der Entwicklung von Gefäßformen und -maßen',
    'description': mark_safe("""ODEEG (Online-Datenbank zur Erforschung der Entwicklung von Gefäßformen und -maßen) is an online database for research on the development of ancient pottery shapes and dimensions, with a special focus on 3D models and filling capacities, and is connected to the wider <a href="https://www.oeaw.ac.at/en/ancient/publications/overview/publikationen-monant/corpus-vasorum-antiquorum/">CVA project</a>.</br>
